...
\section{Relevance to LDPC Decoder Input Reliability}
...
\section{Validation Path for Soft-Information Integration}
...
\section{Integrated Interpretation for BIBCM-ID-Oriented Receivers}
