\subsection{Detailed Soft-Information Model of BIBCM-ID}
...
\subsection{Role of Labeling, Interleaving, and Iterative Gain}
...
\subsection{Practical Receiver Issues}
...
Second, SNR normalization affects both Demodulation and decoding. For coded modulation, symbol energy and bit energy are related by
\begin{equation}
